...
void part1(const std::vector<Numbers>& winning_nums_list, const std::vector<Numbers>& lottery_nums_list)
{
    ...
    for (auto i = 0; i <= num_cards; i++)
    {
        ...
        std::set_intersection(winning_nums.begin(), winning_nums.end(), lottery_nums.begin(), lottery_nums.end(),
...
void part2(const std::vector<Numbers>& winning_nums_list, const std::vector<Numbers>& lottery_nums_list)
{
